...
export default function LiquidationRow({
  ...
  // BUY should be lime (success), SELL should be deep red (destructive)
  const sideColor = side === "long" ? "text-lime-600 dark:text-lime-400" : "text-red-700 dark:text-red-500";
  ...
  return (
    ...
    >
      ...
      <td className="p-2" data-testid={`badge-side-${id}`}>
        <Badge
          className={`flex items-center gap-1 w-fit !text-white ${side === "long" ? "!bg-lime-600 hover:!bg-lime-700 dark:!bg-lime-500 dark:hover:!bg-lime-600" : "!bg-red-700 hover:!bg-red-800 dark:!bg-red-600 dark:hover:!bg-red-700"}`}
        >
